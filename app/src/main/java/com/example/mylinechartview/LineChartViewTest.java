 ...
 * 折线图：有阴影，虚线效果的
 */
public class LineChartViewTest extends View {
    ...
    public LineChartViewTest(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initData();
    }

    public LineChartViewTest(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(List<String> data, List<String> xCoordinateList) {
        ...
        mChartHeight = mScreenHeight * 9 / 40;
        mChartWidth = mScreenWidth * 4 / 5;

        mItemWidth = mChartWidth / (COLUMN_COUNT - 1);
        mItemHeight = mChartHeight / ROW_COUNT;
    ...
    private void initData() {
        ...
        mDataLinePaint.setStrokeWidth(5);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidth(), (int) mChartHeight + 55);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 1; i < mDataList.size(); i++) {
            float itemData = Float.valueOf(mDataList.get(i));
        ...
        for (int i = 0; i < mDataList.size(); i++) {
            float itemData = Float.valueOf(mDataList.get(i));
            String textData = itemData + mYUnits;
